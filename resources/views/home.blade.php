                                    ...
                                    <div class="col-sm-12  mt-5">
                                        <div class="row ">
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-lg-6 ">
                                                        <img src="{{ asset('frontend/images/desing.svg') }}"
                                                            class="img-fluid rounded rounded-lg" alt="">
                                                        <div class=" my-4  text-center justify-content-center">
                                                            <a href=""
                                                                class="btn btn-md  btn-danger delete-confirm rounded-pill "><i
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                                        ...
                                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active rounded-pill profile_tab"
                                                                    id="pills-home-tab" data-toggle="pill"
                                                                    href="#pills-home" role="tab" aria-controls="pills-home"
                                                                    aria-selected="true">Home</a>
                                                            </li>
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link rounded-pill profile_tab"
                                                        ...
                                                        <div class="tab-content" id="pills-tabContent">
                                                            <div class="tab-pane fade show active" id="pills-home"
                                                                ...
                                                                <p class="justify-content-center">
                                                                    ...
                                                                    Quaerat omnis neque reiciendis iste natus atque quasi
                                                                    ratione, eligendi molestias repudiandae consequuntur
                                                                    adipisci debitis nesciunt qui suscipit ab cupiditate
                                                                    labore. Dolores?
                                                                </p>
                                                            ...
                                                            <div class="timeline">
                                                                <div class="events-wrapper">
                                                                    <div class="events" style="width: 1800px;">
                                                                        <ol>
                                                                            <li><a href="#0" data-date="16/01/2021"
                                                                                    class="older-event"
                                                                                    style="left: 120px;">16 Jan</a></li>
                                                                            <li><a href="#0" data-date="28/02/2021"
                                                                                    style="left: 300px;"
                                                                                    class="older-event">28 Feb</a></li>
                                                                            <li><a href="#0" data-date="20/04/2021"
                                                                                    style="left: 480px;" class="selected">20
                                                                                    Mar</a></li>
                                                                            <li><a href="#0" data-date="20/05/2021"
                                                                                    style="left: 600px;">20 May</a></li>
                                                                            <li><a href="#0" data-date="09/07/2021"
                                                                                    style="left: 780px;">09 Jul</a></li>
                                                                            <li><a href="#0" data-date="30/08/2021"
                                                                                    style="left: 960px;">30 Aug</a></li>
                                                                            <li><a href="#0" data-date="15/09/2021"
                                                                                    style="left: 1020px;">15 Sep</a></li>
                                                                            <li><a href="#0" data-date="01/11/2021"
                                                                                    style="left: 1200px;">01 Nov</a></li>
                                                                            <li><a href="#0" data-date="10/12/2021"
                                                                                    style="left: 1380px;">10 Dec</a></li>
                                                                            <li><a href="#0" data-date="19/01/2022"
                                                                                    style="left: 1500px;">29 Jan</a></li>
                                                                            <li><a href="#0" data-date="03/03/2022"
                                                                                    style="left: 1680px;">3 Mar</a></li>
                                                                        </ol>
                                                            ...
                                                            <div class="events-content" style="height: auto;">
                                                                <ol>
                                                                    <li class="" data-date="16/01/2021">
                                                                        <h4>
                                                                            <img class="rounded float-left m-r-15"
                                                                                width="40" alt="user"
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            adipisicing elit. Optio expedita inventore ex
                                                                            tempora dolorem deserunt eum pariatur ut
                                                                            obcaecati fugit? Explicabo odio, ipsa maiores
                                                                            quas distinctio corrupti dicta assumenda?
                                                                            Maxime? <br>
                                                                            <button class="btn btn-primary btn-round">Read
                                                                                more</button>
                                                                        </p>
                                                                    </li>
