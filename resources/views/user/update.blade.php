                           ...
                           @endif
                            ...
                            <form action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" required name="name" placeholder="Enter Full Name"  value="{{ $user->name }}" class="form-control" id="inputEmail3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" required name="email" placeholder="Enter Email address" value="{{ $user->email }}" class="form-control" id="inputEmail3">
