                            ...
                            <form action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 p-0">
                                        <input type="text" required name="name" placeholder="Enter Role Name here"
                                            value="{{ old('name') }}" class="form-control " id="inputEmail3">
                                                ...
                                                <div class="col-sm-3">
                                                    <label for="">
                                                        <input type="checkbox" name="permission[]"
                                                            value="{{ $value->id }}" class="checkSingle" id="">
                                                        {{ $value->name }}
                                                    </label>
                                                </div>
                                            @endforeach
